            ...
            <div class="panel box box-primary">
              ...
              <div id="collapseOne" class="panel-collapse collapse in" role="tabbox" aria-labelledby="headingOne">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <div class="col-md-3">
                      {{Form::label('download_issue_form', trans('admin/settings/general.download_issue_form')) }}
                    </div>
                    <div class="col-md-9">

                      {{Form::checkbox('issue_form', '1', Input::old('issue_form', $setting->issue_form_download), array('class' => 'minimal')) }}
                    </div>
